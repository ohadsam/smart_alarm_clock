...
- Glance API (4 גדלי ווידג'ט, עם שעון חי דרך AndroidRemoteViews, מותאמים למצב בהיר/כהה)
...
לשעמור הבא (ניתנים לשינוי גודל, מתאימים את עצמם למצב התצוגה של המכשיר), מסך לוגים לאבחון, ובדיקות אמינות רקע (התראות/שעמורים מדויקים/סוללה/
מסך מלא/עוצמת שעמור) — מוצעות אוטומטית בכניסה הראשונה לאפליקציה — פירוט מלא
ב-`docs/FEATURES.md`.
