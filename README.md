...
- Glance API (4 גדלי ווידג'ט, עם שעון חי דרך AndroidRemoteViews)
- WorkManager (reschedule on boot, יומי לניקוי לוגים, כל 15 דק' לרענון ווידג'טים)
...
מצב שבת (חוסם אינטראקציה בזמן צפצוף), נודניק שניתן להפעיל לשעמור בודד (כבוי
כברירת מחדל), היסטוריה, ווידג'טים עם שעון חי ואינדיקציית זמן לשעמור הבא, מסך
לוגים לאבחון, ובדיקות אמינות רקע (התראות/שעמורים מדויקים/סוללה) — מוצעות
אוטומטית בכניסה הראשונה לאפליקציה — פירוט מלא ב-`docs/FEATURES.md`.
